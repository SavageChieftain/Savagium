...
export class ResizableDirective implements AfterViewInit, OnDestroy {
  @Input('resizable.disable') isDisable = false

  @Input('resizable.bounds') boundsSelector = 'body'

  @Input('resizable.minWidth') minWidth = 100

  @Input('resizable.minHeight') minHeight = 100
  ...
  private calcCorrectionPosition(
    diff: BoxSize = { left: 0, top: 0, width: 0, height: 0 },
  ): BoxSize {
