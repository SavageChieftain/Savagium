...
export class Terrain extends TabletopObject {
  ...
  get hasWall(): boolean {
    return !!(this.mode & TerrainViewState.WALL)
  }

  get hasFloor(): boolean {
    return !!(this.mode & TerrainViewState.FLOOR)
  }
  ...
  static create(
    ...
    object.commonDataElement.appendChild(
      DataElement.create('depth', depth, {}, `depth_${object.identifier}`),
    )
