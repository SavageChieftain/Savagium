...
export class ChatWindowComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  get gameType(): string {
    return this.chatMessageService.gameType
  }
  ...
  ngOnInit() {
    ...
    this._chatTabidentifier =
      this.chatMessageService.chatTabs.length > 0
  ...
  showTabSetting() {
    ...
    const component = this.panelService.open<ChatTabSettingComponent>(
