    ...
    trigger('diceRoll', [
      transition('* => active', [
        animate(
          ...
          keyframes([
            style({
              transform: 'scale3d(0.8, 0.8, 0.8) rotateZ(0deg)',
              offset: 0,
            }),
            style({
            ...
            style({
              transform: 'scale3d(0.75, 0.75, 0.75) rotateZ(520deg)',
              offset: 0.75,
            }),
            style({
              transform: 'scale3d(1.125, 1.125, 1.125) rotateZ(630deg)',
              offset: 0.875,
            }),
            style({
              transform: 'scale3d(1.0, 1.0, 1.0) rotateZ(720deg)',
              offset: 1.0,
            }),
          ]),
        ),
...
export class DiceSymbolComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  diceRoll(): string {
    EventSystem.call('ROLL_DICE_SYNBOL', {
      identifier: this.diceSymbol.identifier,
    })
