...
export class CardStackListComponent implements OnInit, OnDestroy {
  ...
  constructor(private panelService: PanelService, private changeDetector: ChangeDetectorRef) {}
  ...
  ngOnInit() {
    ...
    EventSystem.register(this)
      .on('UPDATE_GAME_OBJECT', -1000, (event) => {
        ...
        if (
          event.data.identifier === this.cardStack.identifier &&
          this.cardStack.owner !== this.owner
        ) {
