...
export class UIPanelComponent implements OnInit {
  ...
  @Input() set navigation(navigation: boolean) {
    this.panelService.navigation = navigation
  }

  @Input() set draggable(draggable: boolean) {
    this.panelService.draggable = draggable
  }
  ...
  get navigation() {
    return this.panelService.navigation
  }

  get draggable() {
    return this.panelService.draggable
  }
  ...
  private preWidth = 100

  private preHeight = 100
